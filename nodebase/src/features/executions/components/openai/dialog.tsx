        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Configure the settings for OpenAI node.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form
                        ...
                        />
                            ...
                            <FormField
                                ...
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        The main prompt for the OpenAI model. Use {"{{variables}}"} for simple values or {"{{json variables}}"} to stringify complex variables.
                                    </FormDescription>
                                    <FormMessage/>
                                </FormItem>
                            ) }
